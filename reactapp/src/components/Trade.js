...
// <button onClick={()=>{
  ...
  return (
    <>
        <Navbar/>
        <div  className="d-flex justify-content-center mt-4" style={{minHeight:"40vh",minWidth:"100vh"}} >
        <Card>
          <div>
            ...
            <button type="button" class="btn btn-outline-info btn-lg" onClick={handleButtonClick}></button>
          </div>
        </Card>
